                ...
                @foreach($popular as $donghua)
                    <tr>
                        ...
                        <td class="text-center" >
                            <a href="/layouts.populer.detail{{ $donghua ->id }}"><button class="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-700"> <ion-icon name="information-circle-outline"></ion-icon> </button></a>
                        </td>
                    </tr>
                @endforeach
            </tbody>
